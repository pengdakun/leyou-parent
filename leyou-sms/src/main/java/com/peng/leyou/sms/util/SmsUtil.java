package com.peng.leyou.sms.util;
...
//    static final String accessKeySecret = "xxx";
    ...
    public SendSmsResponse sendSms(String phone,String content,String templateCode,String signName) {
        try {
			//可自助调整超时时间
			...
			if (!"ok".equals(code)) {
				log.info("发送短信失败--"+phone+"--"+sendSmsResponse.getMessage());
			}
